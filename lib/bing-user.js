...
module.exports = function(opts, next) {
    ...
    */
    ...
    me.getAvailablePoints = function(next) {
        ...
        spooky.then(function() {
            this.open('http://www.bing.com/rewards/dashboard');
        });
        ...
        spooky.then([{
            ...
            var numPoints = this.evaluate(function() {
                var elm = document.querySelectorAll('.credits-left > .credits');
                if (elm) {
                    elm = elm[0].innerText
                }
                return elm;
            ...
            this.echo('callback:'+index+':'+ numPoints);
        }]);
